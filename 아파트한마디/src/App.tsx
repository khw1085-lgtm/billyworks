...
import type { Apartment, Category, Post, ReportReason } from './types'
...
export default function App() {
  ...
  const boardApartment = useMemo(() => apartments.find((item) => item.id === apartmentId), [apartmentId])
  ...
  const sharePost = async (post: Post) => {
    const apartment = apartments.find((item) => item.id === post.apartmentId)
  ...
  const renderPage = () => {
    ...
    if (path === '/hot') return <HotScreen apartments={apartments} {...common} />
